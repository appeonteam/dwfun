...
type sle_inputto from singlelineedit within w_createdw
end type
type sle_input from singlelineedit within w_createdw
end type
type sle_columnname from singlelineedit within w_createdw
end type
type cbx_retrieve from checkbox within w_createdw
end type
type cb_reset from commandbutton within w_createdw
end type
type cb_4 from commandbutton within w_createdw
end type
type cbx_show from checkbox within w_createdw
end type
type dw_function from datawindow within w_createdw
end type
type dw_selectdw from datawindow within w_createdw
end type
type cb_show from commandbutton within w_createdw
end type
type mle_output from multilineedit within w_createdw
end type
type mle_input from multilineedit within w_createdw
end type
type cb_create from commandbutton within w_createdw
end type
type dw_1 from datawindow within w_createdw
end type
type gb_1 from groupbox within w_createdw
end type
type gb_2 from groupbox within w_createdw
end type
type gb_3 from groupbox within w_createdw
end type
type dw_tmp from datawindow within w_createdw
end type
end forward
...
mle_input.text = string(dw_tmp.object.datawindow.Syntax)
...
IF li_return = 1 THEN 
	...
	wf_output("Failed Create!",true)
	if (ls_ErrBuff = '') then
		wf_output("Error is Empty",false)
	else
...
integer taborder = 10
string title = "none"
string dataobject = "d_dwtype_nup"
boolean hscrollbar = true
boolean vscrollbar = true
boolean livescroll = true
borderstyle borderstyle = stylelowered!
